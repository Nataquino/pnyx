...
const TakeSurvey = () => {
  ...
  const isSmallScreen = useMediaQuery(theme.breakpoints.down("sm")); // Check if the screen is small (e.g., mobile)
  ...
  const handleFeedbackSubmit = async () => {
    ...
    try {
      ...
      console.error(
        "Error submitting feedback or updating preferences:",
        error
      );
    }
  };
    ...
    >
      ...
      <Card
        ...
        sx={{
          ...
          marginX: "auto", // Center the card
        }}
      >
        <Container sx={{ backgroundColor: "#05B1BF", padding: 2 }}>
          <Box sx={{ py: 2, paddingLeft: isSmallScreen ? 2 : 5 }}>
        ...
        <Card sx={{ height: "auto", overflowY: "auto", padding: 2 }}>
          <Container
            sx={{
              display: "flex",
